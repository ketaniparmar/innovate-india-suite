...
// 2. CONFIGURE SMTP TRANSPORTER (Hostinger or Gmail)
const transporter = nodemailer.createTransport({
    host: process.env.SMTP_HOST || 'smtp.hostinger.com', // Default to Hostinger
    port: process.env.SMTP_PORT || 465, // 465 for secure, 587 for TLS
    secure: true, // true for 465, false for other ports
    auth: {
        user: process.env.SMTP_USER, // e.g., reports@hospitalprojectconsultancy.com
